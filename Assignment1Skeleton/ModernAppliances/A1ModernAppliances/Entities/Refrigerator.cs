...
namespace ModernAppliances.Entities
{
    ...
    internal class Refrigerator : Appliance
    {
        ...
        public Refrigerator(int itemnumber, string brand, int quantity, double wattage, string color, double price, int numDoors, double height, double width) : base(brand, color, price, wattage, itemnumber, quantity)
        {
            // Constructor
            NumDoors = numDoors;
            Height = height;
